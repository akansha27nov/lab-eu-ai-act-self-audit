...
In this lab, you apply EU AI Act compliance thinking to work you actually built. Instead of a hypothetical scenario, the subject is your own Week 5 Project project — the AI system you designed and built earlier in the course.
...
- **Learning objectives:** By the end, you can produce a first-pass EU AI Act compliance assessment of a real AI system you built, identify the gaps between your design choices and the Act's requirements, and propose concrete remediation steps.
...
- **Filenames:** Use clear, descriptive names (avoid vague names such as `audit.md` or `compliance_final_v3.pdf`).
- **Scope:** Your **GitHub** repository must contain **only materials for this lab**—no unrelated projects, dumps, or personal files.
- **README:** Add a short file map if you submit multiple documents.
...
Pull up your Week 5 Project project. Your first task is to write a **system brief** — a one-page description of what you actually built, written as if you were handing it to an external reviewer who has never seen it before.
...
### Phase 1: Write the system brief

Use the questions from the Kick-off section. Aim for 300–500 words. No jargon. If a non-technical reviewer could not understand it, rewrite it.

### Phase 2: Risk tier classification

Classify your system and justify the classification. Use this template:
...
- Review your system brief for any components you might have minimized or glossed over (e.g., a third-party API that makes inferences). Does the compliance picture change if you include them?
- Identify one design decision you made earlier in the course that, in hindsight, creates a compliance burden. What would you have done differently?

## Stretch

Pick the single most significant gap you identified and draft the artifact needed to close it:

- A one-page logging policy
- A transparency notice for end users
- A human oversight procedure (who reviews, what they check, how overrides are recorded)
- A draft FRIA scope (who is affected, what rights are at risk, what mitigation is proposed)

Keep it to half a page. The goal is to experience what remediation actually looks like, not to produce a final legal document.
